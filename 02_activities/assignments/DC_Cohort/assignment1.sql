...
CASE when product_qty_type = 'unit' then product_qty_type
...
select v.*, va.booth_number, va.market_date from vendor v 
...
strftime('%Y', market_date) year from customer_purchases
